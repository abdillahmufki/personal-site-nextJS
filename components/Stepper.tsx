...
const Step: React.FC<StepProps> = ({ number, gpa, time, description }) => (
  <div className="flex justify-end">
    <div className="w-[60%] pt-1 pb-8 text-right mt-5 text-sm text-gray-20 dark:text-white">
...
const Stepper: React.FC<StepperProps> = (props) => {
  return (
    <div className=" flex justify-center px-4 lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="w-[500px] lg:me-28 sm:me-10 grid gap-6 row-gap-10 lg:grid-cols-1">
