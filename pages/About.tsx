...
const About = () => {
  ...
  return (
    <div id="about" className="my-16 p-5 grid grid-cols-1 gap-5">
      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="flex justify-between lg:flex-row flex-col lg:gap-10 gap-2 bg-white shadow-md rounded-md">
